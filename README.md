...
Aplicación web completa de e-commerce desarrollada con Next.js 14, orientada a la venta de clases de danza, cursos de nutrición y merchandising oficial de la marca MUEVETE.
...
### Catálogo y carrito
- Listado de productos de merchandising organizados por subcategoría (tazas, remeras, bolsos, botellas, zapatillas, equipamiento)
...
```bash
git clone https://github.com/tu-usuario/nextjs-tf-mareco.git
cd nextjs-tf-mareco
```
