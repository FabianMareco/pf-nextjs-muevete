...
export async function POST(request: Request) {
  try {
    ...
    // Descontar stock solo para merchandising
    ...
    for (const item of order.items) {
      ...
      if (isPack) {
        // Verificar que el pack existe en Firestore pero no descontar stock
        ...
        // Sin descuento de stock para packs (stock ilimitado)
        continue;
      }
 
      // Merchandising: verificar y descontar stock
